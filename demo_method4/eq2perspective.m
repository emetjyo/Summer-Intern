...
% function [out_img,new_h_map,new_w_map] = eq2perspective(img,w_fov,th,phi,out_h,out_w,radius)
function out_img = eq2perspective(img,w_fov,th,phi,out_h,out_w,radius)
if ~exist('radius','var')
    radius = 1;
end
[eq_h,eq_w,~] = size(img);
